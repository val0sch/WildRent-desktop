...
function AddProduct() {
  ...
  const idCategories = (idCategoryId: string) => {// On récupère l'id de la catégorie sélectionnée dans ListCategoriesQuery
  ...
  return (
    <div>
      <div><ListCategories deletable={false} idCategories={idCategories}/></div>
      <input name="name" type="text" placeholder="Nom de l'equipement" onChange={handleChangeName}/>
      <input name="description" type="text" placeholder="Description" onChange={handleChangeDescription}/>
      <input name="price" type="number" placeholder="Prix" onChange={handleChangePrice}/>
      <input name="size" type="text" placeholder="Size" onChange={handleChangeSize}/>
      <input name="stock" type="number" min="0" placeholder="Quantité" onChange={handleChangeStock}/>
